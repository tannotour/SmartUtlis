package com.mitnick.tannotour.smart_lib.cache.disk

import android.content.Context
import android.util.Log
import com.google.gson.Gson
import com.mitnick.tannotour.smart_lib.cache.disk.lru.DiskLruCache
import com.mitnick.tannotour.smart_lib.cache.disk.lru.Util
...
class DiskCacheImpl(var uniqueName: String = "cache", var maxSize: Long = (10 * 1024 * 1024).toLong()): DiskCache {
    ...
    override fun <T> readFromDisk(key: String, clazz: Class<T>): T {
        var value: String = ""
        ...
        val result = Converter.convert(value, clazz)
        if(result == null){
