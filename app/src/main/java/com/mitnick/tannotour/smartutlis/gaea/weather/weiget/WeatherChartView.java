...
import com.mitnick.tannotour.smartutlis.gaea.weather.model.IFakeWeather;
import com.mitnick.tannotour.smartutlis.gaea.weather.utils.SizeUtils;
...
public class WeatherChartView extends LinearLayout {
    ...
    public WeatherChartView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        chartParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
    }
